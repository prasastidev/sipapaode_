...
{#if totalPosts === 0}
 ...
 {:else}
 <p>Terdapat <strong>{totalPosts}</strong> Data Pegawai Pada Tabel (Total dari Database: {data.TableDataPegawai?.total || 0})</p>
 {/if}
 <br/>
         ...
         <TableBodyCell style="font-size: larger;" class="py-4 whitespace-break-spaces content-start">{i+1}</TableBodyCell>
          ...
          <TableBodyCell style="font-size: larger;" class="py-4 whitespace-break-spaces content-start">
              <div style="width:180px;">
                  <b>NIP:</b><br/>{cetakTabel.NIP}<br/><br/>
                  <b>Golongan:</b><br/>{cetakTabel.Golongan}<br/><br/>
                  <b>Jabatan:</b><br/>{cetakTabel.Jabatan}
          ...
          <TableBodyCell style="font-size: larger;" class="py-4 whitespace-break-spaces content-start">
            <ButtonGroup class="*:!ring-primary-700">
              <Button style="color:blue;" on:click={() => getDataPegawai(cetakTabel.$id)}>
                  <EditOutline class="w-4 h-4 me-2" />Edit
              </Button>
               <Button style="color:red;" on:click={() => openDeleteModal(cetakTabel.$id, cetakTabel.Nama)}>
