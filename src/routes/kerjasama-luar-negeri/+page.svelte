...
<br/>
Pengajuan permohonan kerjasama dengan lembaga di luar negeri dapat dilakukan baik melalui <Badge color="yellow" rounded><Indicator color="yellow" size="xs" class="me-1" />Via Kantor</Badge> kantor biro pemerintahan dan otonomi daerah Sulawesi tenggara  ataupun melalui online <Badge color="green" rounded><Indicator color="green" size="xs" class="me-1" />Via Online</Badge> dengan mengisi formulir pada link di bawah berikut.
<br/>
